...
struct GlobalConstantsInitInfo {
	uint32_t pixel_size;
...
// this class is so shit but i cba making it not shit and it works so idk
class GlobalConstants {
public:
	GlobalConstants(const GlobalConstantsInitInfo* init_info);
	...
	// i dont even use this fucntion ever its so shit why does it return an array ??
